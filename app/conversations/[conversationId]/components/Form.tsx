  ...
  return (
    <div className="px-4 py-4 bg-white border-t flex items-center gap-2 lg:gap-4 w-full">
      ...
      <form
        ...
        className="flex ic gap-2 lg:gap-4 w-full"
      >
        <MessageInput
          id="message"
          register={register}
        ...
        <button
          type="submit"
          className="rounded-full w-10 h-10 flex items-center justify-center bg-sky-500 hover:bg-sky-600 cursor-pointer transition  "
        >
